...
%\include{introduction/section} %desaparece
%\include{status_quo/section} %desaparece
\include{about_us/section} %nueva
\include{state-of-the-art/section} %nueva
\include{problem_and_hypothesis/section} %nueva
\include{mathematical_definition/section}
\include{methodology/section} %nueva
\include{results/section}
%\include{visualizations/section} %desaparece
