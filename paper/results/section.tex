...
\caption[KDE evolution while peak $p_1$ is reached]{KDE evolution while peak $p_1$ is reached}
...
\subfigure[Monday, 18:00]{
    \includegraphics[scale = 0.1]{results/images/kernel/18_detail_p2.pdf}
	\label{fig:subfig1_detail}
}
