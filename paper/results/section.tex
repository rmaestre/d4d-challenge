...
\label{fig:fig1}
 &
\subfigure[Thuesday]{
	\includegraphics[scale =0.5] {results/images/thuesday_commuting_lenght.pdf}
	\label{fig:subfig11}
}
\label{fig:fig1}
 &
\subfigure[Wednesday]{
	\includegraphics[scale =0.5] {results/images/wednesday_commuting_lenght.pdf}
	\label{fig:subfig11}
}
\label{fig:fig1}
 &
\subfigure[Thursday]{
	\includegraphics[scale =0.5] {results/images/thursday_commuting_lenght.pdf}
	\label{fig:subfig11}
}
\label{fig:fig1}
\\
\subfigure[Friday]{
	\includegraphics[scale =0.5] {results/images/friday_commuting_lenght.pdf}
	\label{fig:subfig11}
}
\label{fig:fig1}
 &
