...
data = pickle.load(open( "/tmp/domingo/dataset2_matrix.tsv", "rb" ) )

for week_day in ['Sunday']: #, 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'
    filename = "/tmp/domingo/results.tsv"
